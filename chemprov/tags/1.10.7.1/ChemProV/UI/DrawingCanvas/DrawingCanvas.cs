...
namespace ChemProV.UI.DrawingCanvas
{
    ...
    public class DrawingCanvas : Canvas, IXmlSerializable
    {
        ...
        /// <summary>
        /// This is used to decided if main page should route keydown to drawing canvas
        /// </summary>
        ...
        /// <summary>
        /// This is called from main page whenver it gets a key press and drawing canvas has focus.
        /// NOTE: HasFocus1 is what we use for focus since canvas cannot have built-in focus
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        ...
        /// <summary>
        /// Resets the drawing canvas back to its initial state
        /// </summary>
