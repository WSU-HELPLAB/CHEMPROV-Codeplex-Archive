...
namespace ChemProV.PFD.ProcessUnits
{
    ...
    public class ProcessUnitFactory
    {
        ...
        public static IProcessUnit ProcessUnitFromProcessUnit(IProcessUnit unit)
        {
            ...
            IProcessUnit pu = ProcessUnitFromUnitType(ProcessUnitType.Generic);

            //set stuff manually
            pu.Description = unit.Description;            
            pu.Icon = ImageFromString(((BitmapImage)unit.Icon.Source).UriSource.OriginalString);
            pu.MaxIncomingStreams = unit.MaxIncomingStreams;
            pu.MaxOutgoingStreams = unit.MaxOutgoingStreams;
        ...
        public static IProcessUnit ProcessUnitFromUnitType(ProcessUnitType unitType)
        {
            ...
            switch (unitType)
            {
                ...
                default:
                    throw new Exception("Undefied process unit supplied.");
            }
