...
{
    public class ProcessUnitRule : IRule
    {
        private IProcessUnit target;
        ...
        /// </summary>
        Dictionary<string, StreamComponent> incomingCompounds;
        ...
        /// dictionary will have to be built.
        /// </summary>
        Dictionary<string, StreamComponent> outgoingCompounds;

        private ObservableCollection<ValidationResult> results;

        public ProcessUnitRule()
        {
        ...
        /// </summary>
        /// <returns></returns>
        protected ValidationResult CheckCompoundFlowRate()
        {
        ...
        /// </summary>
        /// <returns></returns>
        protected ValidationResult CheckOverallFlowRate()
        {
        ...
        /// <returns></returns>
        private Dictionary<string, StreamComponent> TallyCompounds(IList<IStream> streams)
        {
        ...
        /// <param name="streams"></param>
        /// <returns></returns>
        private Dictionary<string, StreamComponent> TallyCompounds(IStream stream)
        {
            List<IStream> list = new List<IStream>();
            list.Add(stream);
            return TallyCompounds(list);
        }
