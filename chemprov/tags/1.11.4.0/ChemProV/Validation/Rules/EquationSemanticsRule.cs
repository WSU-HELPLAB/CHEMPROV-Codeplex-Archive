...
namespace ChemProV.Validation.Rules
{
    ...
    public class EquationSemanticsRule
    {
        ...
        private ValidationResult isValidEnthalpyEqualsQ()
        {
            ...
            if (equation.Count > 2)
            {
                if (equation[1].Value == "=")
                {
                    ...
                    locationOfQ = 0;
                    index = 2;
                    endOfEntropyCalc = equation.Count;
                }
                else
                {
                    ...
                    endOfEntropyCalc = equation.Count - 3;
        ...
        private ValidationResult sumOfEntropy(int index)
        {
            string currentAbbr;
            ...
            {
                return new ValidationResult(target, ErrorMessageGenerator.GenerateMesssage(ErrorMessages.Unknown_Constant));
            }
            index++;
        ...
        private ValidationResult EquationValidation()
        {
            if (isSumOfOneTable())
            {
        ...
        private bool CheckSameCompound()
        {
            int i = 0;
