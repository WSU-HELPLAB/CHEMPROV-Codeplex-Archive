    ...
    public class MoveStreamHeadCommand : ICommand
    {
        ...
        public bool Execute()
        {
            ...
            if (hoveringOver != null)
            {
                ...
                {
                    CommandFactory.CreateCommand(CanvasCommands.RemoveFromCanvas, streamToMove.Destination, canvas, location).Execute();
                    streamToMove.Destination = null;
                }

                if (hoveringOver.IsAcceptingIncomingStreams)
                {
            ...
            if (streamToMove.Destination == null)
            {
                ...
                CommandFactory.CreateCommand(CanvasCommands.AddToCanvas, Destination, canvas, location).Execute();
            ...
            {
                (streamToMove.Destination as UIElement).SetValue(System.Windows.Controls.Canvas.LeftProperty, location.X);
                (streamToMove.Destination as UIElement).SetValue(System.Windows.Controls.Canvas.TopProperty, location.Y);
            }
            return true;
        }
    }
