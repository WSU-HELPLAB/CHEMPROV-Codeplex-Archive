    ...
    public class DrawingCanvas : Canvas, IXmlSerializable
    {
        ...
        public void GotKeyDown(object sender, KeyEventArgs e)
        {
            if (e.Key == Key.Delete && currentState == selectedState)
            {
                ...
                if (selectedElement is ChemicalStreamPropertiesTable)
                {
                    (selectedElement as ChemicalStreamPropertiesTable).PropertiesTable_KeyDown(sender, e);
                }
                else
                {
        ...
        private XmlSerializer objectFromIPfdElement(IPfdElement element)
        {
            ...
            else if (element is HeatStreamPropertiesTable)
            {
                return new XmlSerializer(typeof(HeatStreamPropertiesTable));
            }
            else if (element is StickyNote)
            {
        ...
        public void ClearDrawingCanvas()
        {
            ...
            HeatStreamPropertiesTable.ResetTableCounter();
        }
