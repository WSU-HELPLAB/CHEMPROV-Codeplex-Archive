...
namespace ChemProV.Validation.Rules.ProcessUnitRules
{
    public class HeatExchangerWithoutUtilityProcessUnitRule : GenericProcessUnitRule
    {
        ...
        private ValidationResult CheckSameUnits()
        {
            ...
            if(matchingStreams1.Item1.GetUnitAtRow(0) != matchingStreams2.Item2.GetUnitAtRow(0))
            {
                return new ValidationResult(feedbackTarget, ErrorMessageGenerator.GenerateMesssage(ErrorMessages.Inconsistant_Units));
            }
        ...
        /// <returns></returns>
        private bool isMatch(IPropertiesTable entering, IPropertiesTable leaving)
        {
